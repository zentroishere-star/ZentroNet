// DarkVeil - WebGL Background Effect using ogl library
class DarkVeil {
  constructor(options = {}) {
    this.options = {
      hueShift: options.hueShift || 1,
      ...
      warpAmount: options.warpAmount || 0.5,
  ...
  init() {
    ...
    try {
      ...
      console.error('DarkVeil initialization failed:', e);
    }
  }
...
document.addEventListener('DOMContentLoaded', () => {
  const darkVeilContainer = document.getElementById('dark-veil-container');
  if (darkVeilContainer) {
    window.darkVeil = new DarkVeil({
      container: darkVeilContainer,
      hueShift: 280,
      noiseIntensity: 0,
      scanlineIntensity: 0,
      speed: 1.4,
